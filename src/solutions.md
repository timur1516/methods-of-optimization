...
$$F_y = 2y + 2xy', \quad F_{y'} = 2xy.$$  
Подставляем в уравнение Эйлера:  
$$2y + 2xy' - \frac{d}{dx}(2xy) = 0 \implies 2y + 2xy' - 2y - 2xy' = 0.$$

Получаем тождество, значит любая функция $y(x)$ является экстремалью.

#### №4

Найти экстремали функционала  
$$J[y] = \int\limits_{x_0}^{x_1} y' (1 + x^2 y') \, dx.$$

Подынтегральная функция:  
$$F = y' (1 + x^2 y') = y' + x^2 y'^2.$$  
Уравнение Эйлера:  
$$F_y - \frac{d}{dx} F_{y'} = 0.$$  
Так как $F_y = 0$, то:  
$$\frac{d}{dx} (1 + 2x^2 y') = 0 \implies 1 + 2x^2 y' = C.$$  
Решаем относительно $y'$:  
$$y' = \frac{C - 1}{2x^2}.$$  
Интегрируем:  
$$y = \frac{1 - C}{2x} + C_1.$$  
Таким образом, экстремали — семейство гипербол:  
$$y = \frac{C_1}{x} + C_2.$$

#### №5

Найти экстремали функционала  
$$J[y] = \int\limits_{x_0}^{x_1} (y'^2 + 2yy' - 16y^2) \, dx.$$
...
$$F_y - \frac{d}{dx} F_{y'} = 0.$$  
Вычисляем производные:  
$$F_y = 2y' - 32y, \quad F_{y'} = 2y' + 2y.$$  
Подставляем в уравнение Эйлера:  
$$2y' - 32y - \frac{d}{dx}(2y' + 2y) = 0 \implies 2y' - 32y - 2y'' - 2y' = 0.$$  
Упрощаем:  
$$y'' + 16y = 0.$$  
Общее решение:  
...
Найти экстремали функционала  
$$J[y] = \int\limits_{x_0}^{x_1} (xy' + y'^2) \, dx.$$
...
Ответ:  
Экстремалями функционала являются квадратичные функции вида:  
$$y(x) = -\frac{x^2}{4} + C_1x + C_2,$$

#### №8

Найти экстремали функционала  
$$J[y] = \int\limits_{x_0}^{x_1} (y^2 + y'^2 - 2y \sin x) \, dx.$$
...
$$F_y - \frac{d}{dx} F_{y'} = 0.$$  
Вычисляем производные:  
$$F_y = 2y - 2 \sin x, \quad F_{y'} = 2y'.$$  
Подставляем в уравнение Эйлера:  
$$2y - 2 \sin x - 2y'' = 0 \implies y'' - y = -\sin x.$$  
Общее решение однородного уравнения:  
$$y_0 = C_1 e^x + C_2 e^{-x}.$$  
Частное решение неоднородного уравнения:  
...
$$y_ч = A \sin x + B \cos x$$
Подставляем в уравнение:  
$$-A \sin x - B \cos x - A \sin x - B \cos x = -\sin x \implies A = \frac{1}{2}, B = 0.$$
Значит:
$$y_ч = \frac{1}{2} \sin x $$
...
Найти экстремали функционала  
$$J[y] = \int\limits_{x_0}^{x_1} \frac{y'^2}{x^3} \, dx.$$
...
$$F_y - \frac{d}{dx} F_{y'} = 0.$$  
Так как $F_y = 0$, то:  
$$\frac{d}{dx} \left( \frac{2y'}{x^3} \right) = 0 \implies \frac{2y'}{x^3} = C.$$  
Решаем относительно $y'$:
...
Найти экстремали функционала  
$$J[y] = \int\limits_{x_0}^{x_1} (y^2 + y'^2 + 2ye^x) \, dx.$$
...
$$F_y - \frac{d}{dx} F_{y'} = 0.$$  
Вычисляем производные:  
$$F_y = 2y + 2e^x, \quad F_{y'} = 2y'.$$  
Подставляем в уравнение Эйлера:  
$$2y + 2e^x - 2y'' = 0 \implies y'' - y = e^x.$$  
Общее решение однородного уравнения:  
$$y_0 = C_1 e^x + C_2 e^{-x}.$$  
Частное решение неоднородного уравнения:  
Метод неопределённых коэффициентов:
$$y_ч = A x e^x.$$
$$A (x e^x + 2e^x) - A x e^x = e^x \implies A = \frac{1}{2}$$ $$y_ч = \frac{1}{2} x e^x.$$
Таким образом, экстремали:  
$$y = C_1 e^x + C_2 e^{-x} + \frac{x e^x}{2}.$$
...
$$F_y = 2y - 2 \sin x, \quad F_{y'} = -2y'.$$  
Подставляем в уравнение Эйлера:  
$$2y - 2 \sin x - \frac{d}{dx} (-2y') = 0 \implies 2y - 2 \sin x + 2y'' = 0.$$  
Упрощаем:  
$$y'' + y = \sin x.$$
...
$$y_0 = C_1 \cos x + C_2 \sin x.$$
Частное решение неоднородного уравнения:  
Методом неопределенных коэффициентов ищем решение вида:  
$$y_ч = A x \cos x + B x \sin x.$$  
Вычисляем производные:  
$$y_ч' = A \cos x - A x \sin x + B \sin x + B x \cos x,$$  
$$y_ч'' = -2A \sin x - A x \cos x + 2B \cos x - B x \sin x.$$  
Подставляем в уравнение:  
$$-2A \sin x - A x \cos x + 2B \cos x - B x \sin x + A x \cos x + B x \sin x = \sin x.$$  
Упрощаем:  

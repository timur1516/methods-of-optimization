...
### Решение уравнения 1: $$y'' - 6y' + 10y = 100$$

**1. Решаем однородное уравнение:**
Характеристическое уравнение:
$$λ^2 - 6λ + 10 = 0 ⇒ λ = 3 \pm i$$
...
**4. Находим константы из начальных условий:**
$$y(0) = C_1 + 10 = 10 ⇒ C_1 = 0$$
...
### Решение уравнения 2: $$\ddot{x} + x = \sin t - \cos 2t$$
...
$$x_ч = A\sin t + B\cos t + C\cos 2t + D\sin 2t$$

После подстановки получаем:
$$x_ч = -\frac{t}{2}\cos t + \frac{1}{3}\cos 2t$$
...
### Решение уравнения 3: $$y''y'' - 3(y')^2 = 0$$

**1. Понижаем порядок заменой:**
$$p = y'$$
$$y'' = p\frac{dp}{dy}$$

Уравнение становится:
$$p^2\left(\frac{dp}{dy}\right)^2 - 3p^2 = 0$$

**2. Разделяем переменные:**
$$\frac{dp}{dy} = \pm\sqrt{3}$$

**3. Интегрируем:**
$$p = \pm\sqrt{3}y + C_1$$

**4. Еще одно интегрирование:**
$$y = C_2e^{\pm\sqrt{3}x} + C_3$$

**Ответ:**
$$y(x) = C_1e^{\sqrt{3}x} + C_2e^{-\sqrt{3}x} + C_3$$

---

### Решение уравнения 5: $$x^2y'' - 4xy' + 6y = 2$$
...
### Решение уравнения 6: $$y'' + y = \operatorname{ch} x$$
...
После подстановки получаем:
$$y_ч = \frac{1}{2}\operatorname{ch} x$$
...
### Решение уравнения 7: $$y'' + \frac{2}{1-y}(y')^2 = 0$$
...
### Решение уравнения 8: $$\frac{d^2x}{dt^2} - 4\frac{dx}{dt} + 4x = e^t + e^{2t} + 1$$
...
После подстановки получаем:
$$x_ч = e^t + \frac{t^2}{2}e^{2t} + \frac{1}{4}$$
...
**4. Еще одно интегрирование:**
$$\int \frac{dx}{\sqrt{C + \frac{1}{x^2}}} = t + C_2$$
...
$$
y_ч = -\frac{x^2}{16} + \frac{1}{128} - \frac{e^x}{15}
$$

Общее решение:

$$
y = C_1e^{2x} + C_2e^{-2x} + C_3\cos 2x + C_4\sin 2x - \frac{x^2}{16} + \frac{1}{128} - \frac{e^x}{15}
$$
